      ...
      <div className="mx-auto flex h-16 max-w-3xl items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex items-center gap-1.5 rounded-lg bg-orange-600 p-2 font-medium font-mono text-sm text-white transition-colors hover:bg-orange-700 sm:px-3 sm:py-1.5"
