          ...
          {filteredCategories.map((category) => (
            <div key={category.name}>
              ...
              <div className="space-y-px">
                {/** biome-ignore lint/complexity/noExcessiveCognitiveComplexity: {contactIndex === 0 && category === filteredCategories[0] && contact.product === firstMatchingProduct} is a valid condition */}
