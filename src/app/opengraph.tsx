        ...
        try {
          ...
          const layout = container({
            ...
            children: [
              ...
              text('Find the right people to reach out to at your favorite tech companies', {
                fontSize: 36,
                fontWeight: 400,
                color: '#f97316',
                marginBottom: 32,
              ...
              text('A community-maintained directory to help developers find the right people to reach out to at tech companies on X (formerly Twitter).', {
                fontSize: 28,
                fontWeight: 400,
                color: '#a1a1aa',
                textAlign: 'center',
